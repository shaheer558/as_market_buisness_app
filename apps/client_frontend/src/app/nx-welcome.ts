      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build client_frontend
<span># Test</span>
nx test client_frontend
<span># Lint</span>
nx lint client_frontend
<span># Run them together!</span>
nx run-many -p client_frontend -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project client_frontend</pre>
          </details>
