      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build rider_frontend
<span># Test</span>
nx test rider_frontend
<span># Lint</span>
nx lint rider_frontend
<span># Run them together!</span>
nx run-many -p rider_frontend -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project rider_frontend</pre>
          </details>
